...
val.forEach((v,i)=>{const col=i%2,row=Math.floor(i/2);const x=0.6+col*3.65,yy=5.8+row*1.95;
  ...
  s.addText(String(i+1),{x:x+0.25,y:yy+0.2,w:0.6,h:0.5,fontFace:LORA,bold:false,fontSize:22,color:LAPACHO});
  s.addText(v[0],{x:x+0.75,y:yy+0.22,w:2.65,h:0.6,fontFace:LORA,bold:false,fontSize:13,color:PETROLEO,lineSpacing:15});

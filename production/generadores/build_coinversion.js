...
s.addText("Coinversión\nInmobiliaria",{x:0.6,y:2.95,w:11,h:1.8,fontFace:LORA,bold:false,fontSize:46,color:CREMA,lineSpacing:50});
...
st.forEach((d,i)=>{const x=0.6+i*3.05;
  ...
  s.addText(d[0],{x:x+0.2,y:2.45,w:2.45,h:1.05,fontFace:LORA,bold:false,fontSize:d[0].length>8?19:29,color:TIERRA,valign:"middle"});
...
tres.forEach((t,i)=>{const x=0.6+i*4.05;
  ...
  s.addText(t[0],{x:x+0.35,y:3.8,w:3.1,h:0.5,fontFace:LORA,bold:false,fontSize:18,color:TIERRA});
...
fases.forEach((f,i)=>{const x=0.6+i*2.44;
  ...
  s.addText(f[0],{x:x+0.25,y:2.9,w:0.9,h:0.9,fontFace:LORA,bold:false,fontSize:34,color:LAPACHO});
  s.addText(f[1],{x:x+0.25,y:3.85,w:1.85,h:0.55,fontFace:LORA,bold:false,fontSize:14,color:PETROLEO,lineSpacing:16});
...
fees.forEach((f,i)=>{const x=0.6+i*4.05;
  ...
  s.addText(f[0],{x:x+0.35,y:3.05,w:3.1,h:0.7,fontFace:LORA,bold:false,fontSize:17,color:CREMA,lineSpacing:20});
  s.addText(f[1],{x:x+0.35,y:3.75,w:3.1,h:0.7,fontFace:LORA,bold:false,fontSize:26,color:LAPACHO});
...
s.addText("USD 636.000",{x:8.35,y:2.9,w:4.1,h:0.8,fontFace:LORA,bold:false,fontSize:34,color:LAPACHO});
...
s.addText("~13,2%",{x:8.35,y:4.75,w:4.1,h:0.5,fontFace:LORA,bold:false,fontSize:22,color:CREMA});
...
gob.forEach((g,i)=>{const col=i%2,row=Math.floor(i/2);const x=0.6+col*6.15,yy=2.2+row*2.05;
  ...
  s.addText(g[0],{x:x+0.35,y:yy+0.25,w:5.2,h:0.5,fontFace:LORA,bold:false,fontSize:16,color:PETROLEO});
...
al.forEach((a,i)=>{const x=0.6+i*3.05;
  ...
  s.addText(a[0].substring(0,2),{x:x+0.3,y:2.6,w:0.7,h:0.7,fontFace:LORA,bold:false,fontSize:18,color:LAPACHO,align:"center",valign:"middle"});
  s.addText(a[0],{x:x+0.3,y:3.5,w:2.35,h:0.8,fontFace:LORA,bold:false,fontSize:15,color:PETROLEO,lineSpacing:18});

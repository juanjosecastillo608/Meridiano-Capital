...
s.addText("MERIDIANO CAPITAL", { x: 1.2, y: 0.58, w: 6, h: 0.5, fontFace: LORA, bold:false, fontSize: 15, color: CREMA, charSpacing: 2, valign: "middle" });
s.addText("ASUNCIÓN, PARAGUAY", { x: 0.6, y: 2.15, w: 6.3, h: 0.4, fontFace: POP, bold: true, fontSize: 13, color: LAPACHO, charSpacing: 3 });
s.addText("Paraguay ya es\ngrado de inversión.", { x: 0.55, y: 2.7, w: 6.5, h: 2.0, fontFace: LORA, bold:false, fontSize: 40, color: CREMA, lineSpacing: 44 });
...
datos.forEach((d) => {
  ...
  s.addText(d[0], { x: 0.6, y: y+0.1, w: 6.3, h: 0.5, fontFace: LORA, bold:false, fontSize: 23, color: LAPACHO });
...
s.addText("Agendá una llamada de 15 minutos", { x: 0.6, y: cy+0.14, w: 6.3, h: 0.5, fontFace: LORA, bold:false, fontSize: 19, color: CREMA, align: "center" });

...
s.addText("MERIDIANO CAPITAL", { x: 1.15, y: 0.5, w: 5, h: 0.5, fontFace: LORA, bold:false, fontSize: 15, color: CREMA, charSpacing: 2, valign: "middle" });
...
s.addText("El momento de invertir en Asunción es ahora.", { x: 0.55, y: 2.3, w: 7.2, h: 1.0, fontFace: LORA, bold:false, fontSize: 30, color: PETROLEO, lineSpacing: 34 });
...
datos.forEach((d,i)=>{
  ...
  s.addText(d[0],{x:x+0.2,y:4.72,w:1.95,h:0.5,fontFace:LORA,bold:false,fontSize:d[0].length>8?17:22,color:TIERRA,valign:"middle"});
  s.addText(d[1],{x:x+0.2,y:5.25,w:1.9,h:0.55,fontFace:POP,fontSize:10.5,color:GREY,lineSpacing:14});
});

// Como trabajamos
s.addText("Acompañamiento de punta a punta", { x: 0.6, y: 6.2, w: 7, h: 0.45, fontFace: LORA, bold:false, fontSize: 18, color: PETROLEO });
s.addText([
...
// Dos formas
s.addText("Dos formas de invertir", { x: 0.6, y: 7.65, w: 7, h: 0.45, fontFace: LORA, bold:false, fontSize: 18, color: PETROLEO });
...
modelos.forEach((m,i)=>{
  ...
  s.addText(m[0],{x:x+0.25,y:8.28,w:3.05,h:0.4,fontFace:LORA,bold:false,fontSize:14,color:TIERRA});

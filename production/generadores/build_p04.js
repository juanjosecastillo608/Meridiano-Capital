...
const portada=[
  ...
  new Paragraph({alignment:AlignmentType.CENTER,spacing:{before:120,after:600},children:[new TextRun({text:"MERIDIANO CAPITAL",font:LORA,bold:false,size:30,color:PET,characterSpacing:60})]}),
  new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:80},children:[new TextRun({text:"MANUAL DE PREVENCIÓN DE LAVADO DE ACTIVOS",font:LORA,bold:false,size:38,color:PET})]}),
  new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:300},children:[new TextRun({text:"Y FINANCIAMIENTO DEL TERRORISMO (PLA/FT)",font:LORA,bold:false,size:38,color:PET})]}),
...
const cierre=[
  ...
  new Paragraph({spacing:{after:80},children:[new TextRun({text:"Aprobación y vigencia",font:LORA,bold:false,size:23,color:PET})]}),

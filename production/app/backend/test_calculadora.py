...
if r_lista["pasa_piso"]: fallos.append("amoblado a 120k NO deberia pasar el piso")
if not r_pozo["pasa_piso"]: fallos.append("amoblado a 75k SI deberia pasar el piso")
...
if rc["renta_sola_pasa_piso"]: fallos.append("Habitalis renta sola NO deberia pasar el piso")

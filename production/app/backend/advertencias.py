...
ADVERTENCIAS_VENTA = [
    (
        ...
        "2026-08-02) que sobreestimaba el IVA real en ~3,33x. Este IVA lo paga la "
        "S.A. del inversor que vende (Modelo A), no Meridiano -- la comision de "
        "Meridiano lleva su propio IVA de servicio (10%), aparte (D-083). Ver "

...
| `Propuesta de trabajo para propietarios.pdf` (STAY WISE) | Documento operativo de un tercero o unidad de negocio sin identificar con certeza | 🟠 REQUIERE VALIDACIÓN — ver FINAL-AUDIT §8 punto 4 |
| `Propuesta de Gestión de Alquiler Temporal.pdf` | Muy similar en contenido al anterior, sin la marca STAY WISE | 🟠 REQUIERE VALIDACIÓN — posible versión previa/genérica del mismo documento |

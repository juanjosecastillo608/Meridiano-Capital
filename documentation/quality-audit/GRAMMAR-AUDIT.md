...
| 6 | ~~`Propuesta de trabajo para propietarios.pdf` / `Propuesta de Gestión de Alquiler Temporal.pdf`~~ | ✅ **Resuelto 2026-08-12 (D-056).** Ninguno de los dos usaba consistentemente el voseo paraguayo ya establecido en el resto del material de marca. Al reformatear ambos como entregables de marca (`Urbannit_Propuesta_Propietarios`, `Urbannit_Propuesta_Gestion_Temporal`), se corrigió a voseo consistente en todo el texto | Baja |

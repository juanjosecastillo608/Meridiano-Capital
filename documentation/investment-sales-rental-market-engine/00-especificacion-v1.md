...
| Ubicación + Google Maps (§6, 17) | No existe | — | Sin geocoding, sin `LOCATION_STATUS`, sin construcción de área de mercado por prioridad |
...
| Target yield / max purchase price (§45-47) | No existe | — | Sin herramienta de "precio máximo de compra para X% objetivo" ni de "alquiler requerido vs. mercado" |
| Informe del inversor de 30 puntos (§51) | Parcial | Los documentos client-ready de HERRERA-001 (Memorándum, Investor Book, Presentación, Investment Summary) cubren gran parte del contenido, pero no siguen esta estructura de 30 puntos ni declaran `SOURCE_STATUS`/`AMC_STATUS` | Falta adoptar la estructura exacta de §51 como plantilla estándar |

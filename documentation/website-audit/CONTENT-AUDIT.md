...
| ~~Sección Proceso — títulos de los 4 pasos ("Cédula paraguaya", "Apertura bancaria"...)~~ | ✅ **Resuelto 2026-08-10 en dos pasadas.** D-049: terminología ("Cédula de identidad paraguaya", "Apertura de cuenta bancaria"). D-052 (Fase 05): tono técnico + **corrección de secuencia** — la versión anterior decía "siempre en este orden" con cédula como paso 1, pero `business/02-camino-migratorio.md` (D-038) documenta que la cédula es opcional/paralela y la vía real es S.A. sin cédula. Nuevo orden: SA sin cédula → cuenta bancaria → cédula (opcional, en paralelo) → selección y cierre, con las 4 descripciones reescritas con voz de "criterio técnico de desarrollador" | ✅ Sí | ❌ No — ya no es intercambiable con cualquier consultora de radicación |
...
**Score de Content original: 7/10** (auditoría inicial). Tras Fase 01 (disclaimer del 10%), Fase 02 (Quiénes Somos con bio/portfolio, Red de Aliados reescrita), Fase 03 — terminología (D-049/D-050: "no mostramos propiedades", cédula de identidad paraguaya, cuenta bancaria, apertura de cuenta bancaria, Unidad 04/05, calculadora) y Fase 05 — Proceso (D-052: tono técnico + secuencia corregida para reflejar la S.A. sin cédula como vía real) — las dos secciones que esta auditoría señalaba en tono genérico (Proceso, Aliados) están resueltas, junto con los tres hallazgos de compliance/contenido. No se re-puntúa formalmente sin una nueva pasada completa, pero no quedan pendientes abiertos de este audit.

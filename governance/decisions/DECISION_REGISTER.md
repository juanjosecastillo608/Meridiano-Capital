...
### D-002 · Pisos de rentabilidad — ¿son BRUTOS o NETOS? — sigue UNRESOLVED, evidencia contradictoria nueva (2026-08-02)
...
- **Estado**: **UNRESOLVED — todavía más incierto que antes de esta ronda.** No se cambió nada en `calculadora.py` ni en `parametros_mercado.json` a partir de esta evidencia — habría sido resolver en silencio justo el tipo de contradicción que este proceso existe para exponer, no para decidir por cuenta propia.
- **Fuente**: `knowledge-base/investment/01-metodologia-calculo.md`, `knowledge-base/investment/02-politica-de-rentabilidad.md`, `00_RAW_MIGRATION/claude-recovery-2026-08-02/CLAUDE.md §5`, `entregables/auditorias/Meridiano_Auditoria_Integral.md §6.4`.
- **Acción antes de producción**: preguntarle directamente al founder — no inferir de ninguna fuente escrita, ya que las dos fuentes disponibles se contradicen entre sí.

...
function title(s,t,dark){s.addText(t,{x:0.6,y:0.9,w:12.1,h:0.95,fontFace:LORA,bold:true,fontSize:29,color:dark?CREMA:PETROLEO,lineSpacing:32});}
...
s.addText("Programa de Ingreso\nal Mercado Paraguayo",{x:0.6,y:2.95,w:11,h:1.8,fontFace:LORA,bold:true,fontSize:42,color:CREMA,lineSpacing:46});
...
comp.forEach((c,i)=>{const x=0.6+i*3.05;
  ...
  s.addText(c[0],{x:x+0.3,y:3.4,w:0.6,h:0.6,fontFace:LORA,bold:true,fontSize:22,color:LAPACHO,align:"center",valign:"middle"});
  s.addText(c[1],{x:x+0.3,y:4.2,w:2.3,h:0.7,fontFace:LORA,bold:true,fontSize:16,color:PETROLEO,lineSpacing:19});
...
pasos.forEach((ps,i)=>{const x=0.6+i*3.05;
  ...
  s.addText(ps[0],{x:x+0.3,y:2.85,w:1,h:1,fontFace:LORA,bold:true,fontSize:40,color:LAPACHO});
  s.addText(ps[1],{x:x+0.3,y:3.9,w:2.35,h:0.7,fontFace:LORA,bold:true,fontSize:15,color:PETROLEO,lineSpacing:18});
...
s.addText("₲ 900.000.000",{x:0.9,y:2.65,w:5.3,h:0.7,fontFace:LORA,bold:true,fontSize:30,color:TIERRA});
...
let y=2.05; kv.forEach(k=>{
  ...
  s.addText(k[0],{x:7.05,y:y+0.08,w:5.5,h:0.3,fontFace:LORA,bold:true,fontSize:13,color:PETROLEO});
...
s.addText("USD 200.000",{x:0.9,y:2.65,w:5.3,h:0.7,fontFace:LORA,bold:true,fontSize:32,color:TIERRA});
...
s.addText("₲ 5.000.000.000",{x:0.9,y:2.65,w:5.3,h:0.7,fontFace:LORA,bold:true,fontSize:28,color:TIERRA});
...
ced.forEach((c,i)=>{const x=0.6+i*4.05;
  ...
  s.addText(c[0],{x:x+0.35,y:3.05,w:3.1,h:0.5,fontFace:LORA,bold:true,fontSize:16,color:PETROLEO});
  s.addText(c[1],{x:x+0.35,y:3.6,w:3.1,h:0.6,fontFace:LORA,bold:true,fontSize:26,color:TIERRA});
...
paq.forEach((c,i)=>{const x=0.6+i*4.05;
  ...
  s.addText(c[1],{x:x+0.35,y:2.62,w:3.1,h:0.6,fontFace:LORA,bold:true,fontSize:16,color:PETROLEO,lineSpacing:19});
  s.addText(c[2],{x:x+0.35,y:3.32,w:3.1,h:0.6,fontFace:LORA,bold:true,fontSize:24,color:TIERRA});
...
raz.forEach((r,i)=>{const col=i%3, row=Math.floor(i/3); const x=0.6+col*4.05, yy=2.15+row*1.95;
  ...
  s.addText(r[0],{x:x+0.85,y:yy+0.22,w:2.7,h:0.6,fontFace:LORA,bold:true,fontSize:13.5,color:PETROLEO,lineSpacing:16});
...
s.addText([{text:"Cédula",options:{}},{text:"   ›   ",options:{color:LAPACHO}},{text:"Cuenta",options:{}},{text:"   ›   ",options:{color:LAPACHO}},{text:"Capital",options:{}},{text:"   ›   ",options:{color:LAPACHO}},{text:"Renta",options:{}}],{x:0.6,y:5.8,w:8,h:0.5,fontFace:LORA,bold:true,fontSize:20,color:CREMA});
// Caja 16 años
s.addShape(p.ShapeType.rect,{x:9.1,y:1.95,w:3.6,h:4.35,fill:{color:NAVY2},line:{color:"2A4A52",width:1}});
s.addText("16",{x:9.1,y:2.6,w:3.6,h:1.2,fontFace:LORA,bold:true,fontSize:72,color:LAPACHO,align:"center"});
...
s.addText("Comencemos su ingreso\nal mercado paraguayo",{x:0.6,y:2.3,w:11,h:1.9,fontFace:LORA,bold:true,fontSize:40,color:CREMA,lineSpacing:44});
...
s.addText("Juan José Castillo",{x:0.6,y:5.35,w:11,h:0.5,fontFace:LORA,bold:true,fontSize:20,color:CREMA});

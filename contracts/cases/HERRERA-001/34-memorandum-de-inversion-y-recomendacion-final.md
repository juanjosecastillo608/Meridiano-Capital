Estado: CURRENT — Memorándum de Inversión y recomendación final (§23-24 del prompt maestro). **Actualizado 2026-08-17 (v2)**: 2 de 3 bloqueantes de due diligence resueltos (`35-...md`), márgenes recalculados con costo definitivo a USD 720/m² + IVA del desarrollador (`36-...md`), y nueva tensión detectada en la política de precios de venta (`37-...md`). **Actualizado 2026-08-18 (v3→v4, mismo día)**: política de precios reconfirmada con AMC parametrizado y 9 comparables reales del propio barrio; hallazgo sobre el valor de terreno dentro del precio de compra planteado y resuelto el mismo día por el founder aplicando D-071 (`45-...md`, D-078, riesgo 🟢) — ingresos y márgenes no cambian en ningún momento
...
**✅ Política de precios confirmada, con respaldo cuantitativo (`38-...md`)**: el founder mantiene el rango USD 1.900–2.050/m² por diferenciación de producto (calidad USD 720/m²) — se comparó directamente contra la alternativa de bajar a calidad USD 650/m² + precio de mercado bajo (USD 1.576–1.809/m², los comparables reales de `37-...md`), y **la política premium gana en los cuatro escenarios probados** (2 Ángulos × 2 extremos de rango), con una diferencia de ROI de 6 a 12 puntos porcentuales a favor de mantener calidad y precio altos. **Reconfirmado 2026-08-18 con el AMC parametrizado** (`45-...md` §1-2): sumando Invicta Herrera, Pampidos y Forvm Herrera, el caso pasa de 2 a 9 comparables reales dentro del propio Barrio Herrera; el ajuste AMC de 2 dormitorios da ~USD 1.509/m² — confirma, con una muestra 4,5 veces mayor, el mismo hallazgo, sin cambiar la política ni los ingresos ya modelados.
...
| **Precio de compra vs. mercado** | Financiero | 🟢 Validado — favorable frente a costo de reposición y comparables de zona |
| **Valor de terreno dentro del precio de compra** | Financiero | ✅ 🟢 **Resuelto 2026-08-18 (D-078)**: el AMC real de un tercero (ARKA, `45-...md` §3-4.1) sugería un valor de terreno vacío equivalente (USD 178.500–203.500) muy por debajo de los USD 360.000 que el trato le asigna — el founder explicó la diferencia (~USD 170.000) aplicando la regla ya vigente D-071 (terreno sin lotes vacantes = casa preexistente + demolición). No cambia el precio total pagado (USD 850.000) ni Inversión Total. Tasación formal del terreno sigue siendo buena práctica recomendada antes del cierre, ya no una alerta activa |
...
Todo lo que sí se pudo verificar apunta a favor: el precio de compra total es defendible frente a costo de reposición y comparables directos de zona (Filum Herrera, `03-...md`); los tres Ángulos de diseño dan margen positivo en todo el rango de sensibilidad de precio; el déficit de caja detectado tiene solución concreta y ya modelada; la demanda de la zona está confirmada con datos reales, no solo con el criterio del founder. **Salvedad agregada 2026-08-18, resuelta el mismo día**: el AMC real de terreno (`45-...md`) había señalado que el desglose interno del precio (terreno USD 360.000) parecía por encima del valor de mercado de un lote vacío — el founder aclaró que esa diferencia corresponde al valor de la casa preexistente + demolición, aplicando la misma regla ya vigente del caso (D-071, terreno sin lotes vacantes disponibles). No cambia el precio total ni el margen; se mantiene como buena práctica una tasación formal del terreno antes del cierre.

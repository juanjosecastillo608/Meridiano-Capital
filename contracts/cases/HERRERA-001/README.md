...
## Estado actual: 🟢 Ritmo de venta y piso de plusvalía cierran casi todos los criterios estructurales

El founder cerró casi todos los bloqueantes estructurales que quedaban. Comisión de venta: **5,5% con IVA incluido**, reparto por canal completo — política cross-cutting **D-063**. Vehículo legal: **SA entre 2-3 socios, 100% del capital**. Plazo de obra: **12 meses**, igual para 6 o 7 pisos. Costo de entrada recalculado con una **tabla general de costos de construcción** (D-064) más el % exacto de incidencia estructural (21%) — Inversión Total Ángulo 1/3 baja a **USD 3.205.927,21** (USD 1.781,07/m² comercializable). **Capital de los socios: 70% por adelantado, 30% a cubrir con venta** — de ahí ya sale el monto mínimo de venta por ángulo. Y ahora se suman dos criterios más (**D-065**): el **ritmo** en que se vende ese mínimo (30% lanzamiento / 40% durante obra / 30% al finalizar) y un **piso de plusvalía anual (15% sobre el precio de venta terminado)** que cuantifica cuándo conviene esperar y vender más tarde en vez de vender ahora — esto último cierra el criterio que faltaba para el escenario de retención total. Ver `08-...md` a `11-ritmo-de-venta-y-piso-de-plusvalia.md`.
...
| `11-ritmo-de-venta-y-piso-de-plusvalia.md` | **Nuevo (2026-08-15)**: ritmo de venta por etapa (30/40/30, D-065) aplicado al monto mínimo de venta ya confirmado, y piso de plusvalía anual (15% sobre precio de venta terminado) que cuantifica el escenario de retención total |

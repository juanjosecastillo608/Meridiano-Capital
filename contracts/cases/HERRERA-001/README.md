...
| `entregables/HERRERA-001_Memorandum_de_Inversion.docx` / `.pdf` | **Nuevo (2026-08-17)**: versión formal y con formato del Memorándum de Inversión (`34-...md`), lista para compartir con el equipo/socios — generada con `production/generadores/build_herrera001_memorandum.js` |

...
El mecanismo de 1,5% efectivo está bien verificado (fuente Nivel 1, DNIT) para la **primera venta de obra nueva por una persona jurídica** — exactamente el caso de HERRERA-001 (Meridiano vende como desarrollador, Modelo B). Para los escenarios de **reventa de portafolio** que modela `calculadora.py` (`evaluar_reventa`, Modelo A — el inversor vende, no Meridiano), había quedado una duda real: si esas ventas podrían estar exentas de IVA (régimen IRP en su lugar) por no ser necesariamente "obra nueva".

**Actualización 2026-08-23, mismo día (D-083)**: el founder aclaró el modelo de negocio real — *"Meridiano solo vende y factura la unidad cuando actúa como desarrollador y/o coinversión. Meridiano es un intermediario en el 90% de los casos, porque son los inversores a través de las Sociedades Anónimas que creamos como vehículos para la inversión [quienes venden y facturan]"*. Esto **resuelve la mayor parte de la duda**: en el Modelo A el vendedor real es la S.A. del inversor (no una persona física sin vehículo), así que el régimen de IVA de inmuebles (1,5% efectivo) aplica igual, sin importar si es "obra nueva" — lo que importa es que quien factura es una persona jurídica. Ver `knowledge-base/investment/methodologies/iva-venta-de-inmuebles-paraguay.md` §2-3 para el detalle completo. **No es específico de HERRERA-001** (acá Meridiano ya vende como desarrollador, sin ambigüedad) pero se documenta acá porque esta corrección nació de este caso.

**Remanente real, sin verificar formalmente**: si cada S.A.-vehículo califica como sujeto habitual de IVA desde su primera operación — riesgo residual bajo, no una duda activa.

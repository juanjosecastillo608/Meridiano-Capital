...
- **Acción antes de producción**: ~~no publicar/usar la calculadora hasta fijar este valor~~ — ya implementado en `app/backend/calculadora.py` y `app/config/parametros_mercado.json`.

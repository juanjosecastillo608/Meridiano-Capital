...
| RE/MAX | 3 | Portal inmobiliario / franquicia | Comparables reales de venta (D-077, `market-intelligence/sales/`, `market-intelligence/land/`) — Invicta Herrera, Forvm Herrera, terrenos del AMC de ARKA | Alta para el dato puntual citado (listado vigente, precio real) — igual salvedad que Century 21, es precio de lista, no de cierre |
| InfoCasas, MercadoProp | 3 | Portales inmobiliarios | Búsquedas de primer corte para `rentals/`, `airbnb/`; 1 comparable de terreno real (D-077, `market-intelligence/land/`) | Media — agregadores de terceros, sin verificación directa del listado original |
| ARKA Desarrollos Inmobiliarios (informe AMC de terceros) | — | Informe de un competidor/tercero, no un portal | Contexto de `market-intelligence/land/` (D-077) — **solo se adoptaron sus 5 comparables públicos citables; su muestra de "12 ventas confidenciales" y su herramienta de tasación online NO se adoptaron como dato propio** (no verificables independientemente) | No calificable en la jerarquía Nivel 1-5 — es un informe de tercero, se trata caso por caso qué partes son verificables |
